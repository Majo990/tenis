...
INSERT INTO `arbitros` VALUES (5,'Mario','Perez','Angola','Cacole',22,'Masculino',1.55,55,'2000-01-02'),(6,'Juan','Montero','Algeria','Batna City',22,'Masculino',1.6,50,'2000-01-18'),(7,'Celeste','Gonzales','Australia','Aberfoyle',28,'Femenino',0.17,60,'1999-06-20'),(8,'Frescia','Perleche','Peru','Piura',20,'Femenino',1.58,50,'2002-12-12');
...
INSERT INTO `canchas_estadios_partidas` VALUES (1,'cancha1',2,1),(2,'cancha2',1,2),(4,'cancha4',1,7),(5,'cancha 5 ',2,9),(6,'cancha7',2,11);
...
INSERT INTO `equipos` VALUES (1,'Breaking Bad','Peru','Lima','2000-12-02',2,1,'equipo ganador eliminatoria 2019','polo y short celeste','Pedro Caseres','Bad',1,'1.png'),(2,'Pink','Peru','Lima','2021-05-12',3,3,'Equipo mujeres','Falta tipo short y polo rosado','Celeste','Pinkis',1,'1.png'),(3,'Universidad de California, Los Ángeles (UCLA)  ','Germany','Abstatt','1919-01-07',2,4,'El mejor equipo de EE.UU',' Polo y short','Edward Augustus','Ucla',1,'2.png'),(4,'Juego Set Match','Peru','Cajamarca','2020-01-01',3,3,'Ganadores de la eliminatoria 2020','Polo y Short azul','Paolo Ruiz','Match',1,'2.png'),(5,'rojo','Anguilla','Island Harbour','2023-01-10',2,2,'ddd','dd','dd','dd',1,'1.png');
...
INSERT INTO `estadios` VALUES (1,'Estadio Nacional Perú ',2,NULL,'natural','Miguel Dasso','Gobierno del Perú ',15010,'Estadio Nacional, Paseo de la Republica Avenue 652, Lima, Lima 15046','Peru','Lima',1),(2,'Club Grau',3,NULL,'sintetico','Guillermo Herrera','Guillermo Herrera',1885,'Avenida los Cocos.','Peru','Piura',NULL);
...
INSERT INTO `faltas` VALUES (12,3,'2023-01-12 12:00:00',2,5,NULL,2),(13,5,'2023-01-12 14:14:00',2,5,NULL,2);
...
INSERT INTO `jugadores` VALUES (1,'Pedro Gallese ','Peruana',1,32,'Masculino',5,1,1,3,1.89,77,'Peru','Miraflores',NULL),(2,'Paolo Guerrero ','peruana',1,39,'Masculino',5,1,1,2,1.85,77,'Peru','Lima',NULL),(3,'Fabiola','peruana',2,23,'Femenino',6,1,1,2,1.8,70,'Argentina','Acevedo',NULL),(4,'Ruby','Dominicana',2,23,'Femenino',7,2,1,2,0.18,0.7,'Dominica','Saint David','Derecha');
...
INSERT INTO `partidas` VALUES (1,'Partidauno','Eliminatorias ',1,'2023-01-13','09:30:00','01:00:00','10:30:00',3,'Tenis'),(2,'Partidados','Partida selección equipo ',1,'2023-01-13','08:54:00','00:30:00','15:15:00',3,'Fútbol'),(7,'Partida tres ','partida hoy ',1,'2023-01-13','12:00:00',NULL,NULL,2,'Tenis'),(9,'partida cinco','partida mañana',1,'2023-01-13','13:16:11',NULL,NULL,1,'Tenis'),(11,'Partida siete ','ss',1,'2023-01-13','15:00:00',NULL,NULL,1,'Tenis'),(12,'ggg','g',2,'2023-01-12','17:00:00',NULL,NULL,2,'Tenis'),(13,'fff','fff',1,'2023-01-25','07:17:09',NULL,NULL,2,'Fútbol');
...
INSERT INTO `partidas_jugadores` VALUES (17,1,3),(18,1,4),(19,2,2),(20,2,1),(21,7,3),(24,7,2),(25,9,1),(26,9,4),(27,NULL,1),(28,NULL,4),(29,11,4),(30,11,3),(31,12,2);
...
INSERT INTO `perfiles` VALUES (1,'Victor','Carrasco',21,'Masculino','12345677','g','victor3@gmail.com','av. Lima frente a una posta',111111111,4,'Albania','Petran',2000),(2,'Maria','Yanayaco',44,'Femenino','444','h','mariayanayaco@gmail.com','av.Belaunde',999999999,7,'Albania','Elbasan',2000);
...
INSERT INTO `usuarios` VALUES (4,'majo','f0832159af15968232ea007347f31827',NULL),(7,'majo3','123',NULL);
...
-- Dump completed on 2023-01-13 17:19:00
