...
INSERT INTO `arbitros` VALUES (5,'Mario','Perez','Angola','Cacole',18,'Masculino',1.55,0.55,'2000-01-06'),(6,'Juan','Montero','Algeria','Batna City',22,'Masculino',1.6,50,'2000-01-18'),(7,'Celeste','Gonzales','Australia','Aberfoyle',28,'Femenino',0.17,60,'1999-06-20'),(8,'Frescia','Perleche','Peru','Piura',20,'Femenino',1.58,50,'2002-12-12'),(9,'Mario','Jose',NULL,NULL,NULL,'Masculino',1.6,60,'2000-01-04'),(10,'Maria','Castro',NULL,NULL,NULL,'Femenino',1.6,50,'1982-01-14');
...
INSERT INTO `canchas_estadios_partidas` VALUES (1,'cancha1',2,1),(2,'cancha2',1,2),(4,'cancha4',1,7),(5,'cancha 5 ',2,9),(6,'cancha7',2,11),(7,'cancha8',1,14),(9,'cancha9',2,11);
...
INSERT INTO `comportamientos` VALUES (1,'Actitud Positiva',3,5,1),(2,'Actitud Negativa no respeto las reglas',2,6,2),(3,'Actitud Positiva respeto las reglas',1,7,1);
...
INSERT INTO `entrenadores` VALUES (1,'Jose',2,'Castro',20,'Masculino','1999-01-12','Angola','Benguela'),(2,'Rafael',NULL,'Mogollon',22,'Femenino','2000-01-20','Albania','Elbasan'),(3,'Angela',NULL,'Perleche',20,'Femenino','2002-12-05','Algeria','Annaba'),(4,'Paulina',2,'Moran',26,'Femenino','1996-01-02','Australia','Abbotsford');
...
INSERT INTO `equipos` VALUES (1,'Breaking Bad','Peru','Lima','2000-12-02',2,1,'equipo ganador eliminatoria 2019','polo y short celeste','Pedro Caseres','Bad',1,'2.png'),(2,'Pink','Peru','Lima','2021-05-12',3,3,'Equipo mujeres','Falta tipo short y polo rosado','Celeste','Pinkis',1,'club.jpg'),(3,'Universidad de California, Los Ángeles (UCLA)  ','Germany','Abstatt','1919-01-07',2,4,'El mejor equipo de EE.UU',' Polo y short','Edward Augustus','Ucla',1,'2.png'),(4,'Juego Set Match','Peru','Cajamarca','2020-01-01',3,3,'Ganadores de la eliminatoria 2020','Polo y Short azul','Paolo Ruiz','Match',1,'2.png'),(5,'rojo','Anguilla','Island Harbour','2023-01-10',2,2,'ddd','dd','dd','dd',1,'1.png'),(6,'Equipos azul','null','null','2023-01-17',2,2,'ggggg','ffff','ffff','fff',1,'tenis.jpg'),(7,'vv','null','null','2023-01-03',1,1,'vvv','vvv','vvvvvv','vvvv',1,'2.png');
...
INSERT INTO `estadios` VALUES (1,'Estadio Nacional Perú ',2,2,'natural','Miguel Dasso','Gobierno del Perú ',15010,'Estadio Nacional, Paseo de la Republica Avenue 652, Lima, Lima 15046','Peru','Lima',1),(2,'Club Grau',3,1,'sintetico','Guillermo Herrera','Guillermo Herrera',1885,'Avenida los Cocos.','Peru','Piura',7);
...
INSERT INTO `faltas` VALUES (12,3,'2023-01-12 12:00:00',2,5,NULL,2),(13,5,'2023-01-12 14:14:00',2,5,NULL,2),(16,2,'2023-01-16 00:00:00',1,5,NULL,11);
...
INSERT INTO `historial_partidas` VALUES (1,3,'2023-01-06 01:23:00',1,1,3,1,1,NULL,1,7),(2,2,'2023-01-04 10:00:00',2,2,2,1,1,NULL,2,5),(3,1,'2023-01-04 12:00:00',2,2,3,1,1,NULL,2,6),(4,4,'2023-01-12 00:02:00',1,0,1,2,2,NULL,11,8);
...
INSERT INTO `jugadores` VALUES (1,'Pedro Gallese ','Peruana',1,32,'Masculino',5,1,1,3,1.89,77,'Peru','Miraflores',NULL,'2023-01-17'),(2,'Paolo Guerrero ','peruana',1,39,'Masculino',5,1,1,2,1.85,77,'Peru','Lima',NULL,'2023-01-17'),(3,'Fabiola','peruana',2,23,'Femenino',6,1,1,2,1.8,70,'Argentina','Acevedo',NULL,'2023-01-17'),(4,'Ruby','Dominicana',2,23,'Femenino',7,2,1,2,0.18,0.7,'Dominica','Saint David','Derecha','2023-01-17');
...
INSERT INTO `partidas` VALUES (1,'Partidauno','Eliminatorias ',1,'2023-01-13','09:30:00','01:00:00','10:30:00',3,'Tenis'),(2,'Partidados','Partida selección equipo ',1,'2023-01-13','08:54:00','00:30:00','15:15:00',3,'Fútbol'),(7,'Partida tres ','partida hoy ',1,'2023-01-16','12:00:00',NULL,NULL,2,'Tenis'),(9,'partida cinco','partida mañana',1,'2023-01-16','13:16:11',NULL,NULL,1,'Tenis'),(11,'Partida siete ','febrero',1,'2023-01-16','15:00:00',NULL,NULL,1,'Tenis'),(12,'partida ocho','partida mañana',2,'2023-01-17','17:00:00',NULL,NULL,3,'Tenis'),(14,'partida nueve','hoy',1,'2023-01-16','12:20:00',NULL,NULL,3,'Tenis');
...
INSERT INTO `partidas_jugadores` VALUES (36,1,1),(37,1,2),(38,2,3),(39,2,4),(40,11,1),(42,9,1),(43,9,4),(44,7,3),(45,7,4),(46,14,2),(47,14,1),(50,11,2),(51,1,2);
...
INSERT INTO `perfiles` VALUES (1,'Victor','Carrasco',21,'Masculino','12345677','g','victor3@gmail.com','av. Lima frente a una posta',111111111,4,'Albania','Petran',2000),(2,'Maria','Yanayaco',44,'Femenino','444','h','mariayanayaco@gmail.com','av.Belaunde',999999999,NULL,'Albania','Elbasan',2000);
...
CREATE TABLE `puntajes` (
  ...
  `id_partidas` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `puntajes_FK` (`id_equipos`),
  KEY `puntajes_FK_1` (`id_jugadores`),
  KEY `puntajes_FK_2` (`id_partidas`),
  CONSTRAINT `puntajes_FK` FOREIGN KEY (`id_equipos`) REFERENCES `equipos` (`id`) ON DELETE SET NULL,
  CONSTRAINT `puntajes_FK_1` FOREIGN KEY (`id_jugadores`) REFERENCES `jugadores` (`id`) ON DELETE SET NULL,
  CONSTRAINT `puntajes_FK_2` FOREIGN KEY (`id_partidas`) REFERENCES `partidas` (`id`) ON DELETE SET NULL
...
INSERT INTO `puntajes` VALUES (26,'0',NULL,1,7),(27,'0',NULL,2,7),(30,'0',NULL,2,14),(31,'0',NULL,1,14),(32,'0',NULL,4,7),(33,'0',NULL,3,7),(35,'1',NULL,1,11),(36,'0',NULL,2,11);
...
INSERT INTO `usuarios` VALUES (4,'majo','f0832159af15968232ea007347f31827',NULL);
...
-- Dump completed on 2023-01-17 17:53:40
