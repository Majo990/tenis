const routes = [
  {
    ...
    children: [
      ...
      {path: "/formulario",component:() => import("pages/FormularioPage.vue")},
      ...
      {path:"/comportamientos",component:()=> import("pages/ComportamientosPage.vue")},
       {path:"/entrenadores",component:()=> import("pages/EntrenadoresPage.vue")},
      ...
      {path:"/historial-partidas",component:()=> import("pages/Historial-PartidasPage.vue")},
      ...
      {path:"/partidas-jugadores",component:()=> import("pages/Partidas-JugadoresPage.vue")},
      {path:"/premios", component:()=> import("pages/PremiosPage.vue")},
      {path:"/rondas", component:()=> import("pages/RondasPage.vue")},
      {path:"/sanciones", component:()=> import("pages/SancionesPage.vue")},
